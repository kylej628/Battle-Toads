...
public class GuiClass {
	...
	public GuiClass(Texture GUIBackground, int width, int height, Justify just)
	{
		...
		health = new Component(this, "health", 150, 35, 0, 50, 100, Justify.RIGHT_TOP, new Texture(Gdx.files.internal("assets/play/GUI Resources/heart.png")), new Texture(Gdx.files.internal("assets/play/GUI Resources/alpha_105.png")));
		coins = new Component(this, "coins", 150, 35, 0, 0, 99999, Justify.RIGHT_BOTTOM, new Texture(Gdx.files.internal("assets/play/GUI Resources/coin.png")), new Texture(Gdx.files.internal("assets/play/GUI Resources/alpha_105.png")));
