...
public class Button {
	...
	public Button(String Name, int positionX, int positionY, Justify justification, int width, int height, boolean displayName)
	{
		...
		button = new Texture[]{
			new Texture(Gdx.files.internal("assets/defaults/button_up_default.png")), new Texture(Gdx.files.internal("assets/defaults/button_down_default.png")), new Texture(Gdx.files.internal("assets/defaults/button_hover_default.png"))	
		};
		FONT = new BitmapFont();
